...
**当前版本：[DSH Desktop v0.1.2](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/tag/v0.1.2)**

| 平台 | 推荐下载 |
| --- | --- |
| Windows x64 | [EXE 安装包](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.2/DSH.Desktop_0.1.2_x64-setup.exe) |
| Windows x64（企业或集中部署） | [MSI 安装包](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.2/DSH.Desktop_0.1.2_x64_zh-CN.msi) |
| Apple 芯片 Mac | [DMG 安装包](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.2/DSH.Desktop_0.1.2_aarch64.dmg) |
| Intel 芯片 Mac | [DMG 安装包](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.2/DSH.Desktop_0.1.2_x64.dmg) |
